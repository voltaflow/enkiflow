    ...
    function showNotification(title, message) {
        ...
        if (!notification) {
            ...
            notification.className =
                'fixed top-4 right-4 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-4 w-80 transform transition-transform duration-300 ease-in-out translate-x-full';
