...
export function TimeEntryForm({ projects, tasks, categories, initialValues = {}, onSubmit, onCancel, mode = 'create' }: TimeEntryFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
                    ...
                    <Select value={projectId?.toString() || ''} onValueChange={(value) => setProjectId(value ? parseInt(value) : null)}>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="flex items-end">
                    <div className="flex items-center space-x-2">
                        <Checkbox id="billable" checked={isBillable} onCheckedChange={(checked) => setIsBillable(!!checked)} />
            ...
            {mode === 'manual' && (
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center">
                            <Clock className="text-muted-foreground mr-2 h-4 w-4" />
                            <Input id="end-time" type="time" value={endTime} onChange={(e) => setEndTime(e.target.value)} min={startTime} />
                        </div>
                    </div>
                </div>
            )}
