...
export const ProjectRoleManagerSimple: React.FC<ProjectRoleManagerProps> = ({
    open,
    onOpenChange,
    projectId,
    projectName,
    ...
    // Clean up state after modal fully closes
    useEffect(() => {
        if (!open) {
    ...
    const handleCloseError = () => {
        setError(null);
        // Close the modal if we can't load the data
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent
                className="flex max-h-[90vh] max-w-[600px] flex-col overflow-hidden"
            ...
            >
                <DialogHeader>
                    <DialogTitle>Permisos de Proyecto</DialogTitle>
                    <DialogDescription>
                ...
                {loading ? (
                    ...
                    <Alert variant="destructive" className="my-6">
                        ...
                        <AlertDescription className="flex items-center justify-between">
                            <span>{error}</span>
                            <Button size="sm" variant="outline" onClick={handleCloseError} className="ml-4">
                                Cerrar
                            </Button>
                        </AlertDescription>
                    </Alert>
