...
export function DuplicateDayAction({ onDuplicate, disabled = false, className }: DuplicateDayActionProps) {
    ...
    return (
        <>
            <Button variant="outline" onClick={() => setShowDialog(true)} disabled={disabled} className={cn('w-full', className)}>
            ...
            <Dialog open={showDialog} onOpenChange={setShowDialog}>
                <DialogContent className="sm:max-w-[500px]">
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleDuplicate} disabled={!fromDate || !toDate || isLoading}>
                            {isLoading ? (
                                <>
