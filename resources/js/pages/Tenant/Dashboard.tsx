...
export default function Dashboard({ 
  ...
  const userTaskCompletionPercent = basicStats.userTasksCount > 0 
    ? Math.round((basicStats.userCompletedTasksCount / basicStats.userTasksCount) * 100) 
    : 0;
    
  const allTaskCompletionPercent = extendedStats && extendedStats.allTasksCount > 0 
    ? Math.round((extendedStats.allCompletedTasksCount / extendedStats.allTasksCount) * 100) 
    : 0;
          ...
          <div className="mb-10">
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mb-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <span className="text-xs font-medium text-muted-foreground">En Progreso</span>
                  ...
                  <div className="flex justify-between items-center mt-1">
                    ...
                    <span className="text-xs font-medium">{basicStats.userPendingTasksCount - basicStats.userInProgressTasksCount}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="mt-2">
                    <Button asChild variant="ghost" size="sm" className="p-0 h-auto text-xs text-muted-foreground hover:text-primary">
                      <Link href={route('tasks.index', { status: 'overdue' })}>
                        Ver tareas vencidas →
                      </Link>
                    </Button>
                  </div>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-muted-foreground">Tus Proyectos</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Últimas tareas creadas o actualizadas asignadas a ti
                </CardDescription>
              </CardHeader>
              <CardContent>
                {basicStats.recentTasks.length > 0 ? (
                  <div className="space-y-4">
                    {basicStats.recentTasks.map((task) => (
                      <div key={task.id} className="flex justify-between items-start border-b pb-3 last:border-0 last:pb-0">
                        <div>
                          <Link 
              ...
              <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mb-6">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-2">
                      {extendedStats.allCompletedTasksCount} de {extendedStats.allTasksCount} completadas ({allTaskCompletionPercent}%)
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-muted-foreground">Estado de Tareas</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <div className="text-xs">
                      ...
                      <Progress value={extendedStats.allPendingTasksCount / extendedStats.allTasksCount * 100} className="h-1" />
                    </div>
                    <div className="text-xs">
                      <div className="flex justify-between mb-1">
                      ...
                      <Progress value={extendedStats.allInProgressTasksCount / extendedStats.allTasksCount * 100} className="h-1" />
                    </div>
                    <div className="text-xs">
                      <div className="flex justify-between mb-1">
                      ...
                      <Progress value={extendedStats.allCompletedTasksCount / extendedStats.allTasksCount * 100} className="h-1" />
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-muted-foreground">Total de Proyectos</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-muted-foreground">Proyectos Destacados</CardTitle>
                  </CardHeader>
                  <CardContent>
            ...
            <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Tareas que han superado su fecha de vencimiento y requieren atención
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="space-y-4">
                      {taskStats.overdueTasks.map((task) => (
                        <div key={task.id} className="flex justify-between items-start border-b pb-3 last:border-0 last:pb-0">
                          ...
                          <div className="flex-shrink-0 text-xs text-red-600 font-medium">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Tareas con fecha de vencimiento en los próximos 7 días
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="mt-4">
                    <Button asChild variant="outline" size="sm">
                      <Link href={route('tasks.index', { due_soon: true })}>
                        Ver todas las tareas próximas
                      </Link>
                    </Button>
                  </div>
                </CardContent>
              ...
              <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Usuarios con más tareas completas y pendientes
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-6">
                      <div>
                        <h3 className="text-sm font-medium mb-2">Top Usuarios por Tareas Completadas</h3>
                      ...
                      <div>
                        <h3 className="text-sm font-medium mb-2">Top Usuarios por Tareas Abiertas</h3>
                        <div className="space-y-2">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Últimas acciones realizadas en el espacio
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
          ...
          <div>
            ...
            <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              ...
              <Card className="hover:bg-muted/50 transition-colors">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-4">
                    Inicia un nuevo proyecto para organizar tus tareas
                  </p>
                  <Button asChild>
              ...
              <Card className="hover:bg-muted/50 transition-colors">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-4">
                    Revisar el estado de todos los proyectos activos
                  </p>
