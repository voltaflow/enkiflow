...
export default function Edit({ client }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('tenant.clients.update', client.id));
    };
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-4">
                        <Link href={route('tenant.clients.show', client.id)}>
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground mt-1">Actualiza la información de {client.name}</p>
                        </div>
                    </div>
